...
#=================== Calculation ====================
# Prepare DAT file
outputfile = "langevin_data_png.dat"
...
#=================== Animation ====================
set term png enhanced size 960,720
system 'mkdir png'
png_num = 0	# Counter (PNG images)

set grid
set nokey
L = 1.5e2
set xr[-L/2:L/2]
set yr[-L/2+60:L/2+60]
...
do for [i = 0:limit:skip] { 	#[start:end:increment]
	...
	set output sprintf('png/img_%04d.png', png_num)
